...
public class SandboxArreglos
{
    ...
    public int[] getCopiaEnteros( )
    {
        ...
        for (int ini=0; ini < arregloEnteros.length; ini++ ) {
        	copiaArreglo[ini] = arregloEnteros[ini]; 	
        }
    ...
    public String[] getCopiaCadenas( )
    {
        ...
        for (int ini=0; ini < arregloCadenas.length ; ini ++) {
        	copiaCadenas[ini] = arregloCadenas[ini];
        }
    ...
    {
    	int[]nuevoEspacio = new int[arregloEnteros.length + 1];
    	for (int i=0; i< arregloEnteros.length; i ++) {
    		nuevoEspacio[i] = arregloEnteros[i];
    	}
    	
    	nuevoEspacio[arregloEnteros.length] =  entero;
    	
    	arregloEnteros = nuevoEspacio;
    }
    ...
    {
    	String[] nuevoEspacio = new String[arregloCadenas.length + 1];
    	for (int i=0; i< arregloCadenas.length; i ++) {
    		nuevoEspacio[i] = arregloCadenas[i];
    	}
    	nuevoEspacio[arregloCadenas.length] = cadena;
    	arregloCadenas = nuevoEspacio;
    }
    ...
    public int contarApariciones( String cadena )
    {
        ...
        for (String str : arregloCadenas) {
            if (str.toLowerCase().equals(cadenaBuscada)) {
                contador++;
            }
        }
    ...
    public boolean mismosEnteros( int[] otroArreglo )
    {
        ...
        HashMap<Integer, Integer> conteoArreglo_1 = new HashMap<>();
        for (int valor : arregloEnteros) {
            conteoArreglo_1.put(valor, conteoArreglo_1.getOrDefault(valor, 0) + 1);
        }

        HashMap<Integer, Integer> conteoArreglo_2 = new HashMap<>();
        for (int valor : otroArreglo) {
            conteoArreglo_2.put(valor, conteoArreglo_2.getOrDefault(valor, 0) + 1);
        }

        return conteoArreglo_1.equals(conteoArreglo_2);    } //True si ambos mapas tienen las mismas claves y valores asociados
    														 //False si los mapas tienen diferentes claves o valores asociados 
    /**
    ...
    {
        if (cantidad > arregloEnteros.length) {

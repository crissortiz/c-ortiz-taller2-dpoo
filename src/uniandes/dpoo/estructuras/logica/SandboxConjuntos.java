...
public class SandboxConjuntos
{
    ...
    public Collection<String> getSiguientes( String cadena )
    {
        ...
        return new ArrayList<>(siguientes);    }
    ...
    {
        if (cadena == null || arbolCadenas.isEmpty()) {
            return;
        }
        ...
        for (String elem : arbolCadenas) {
            if (elem.toLowerCase().equals(cadenaLower)) {
                arbolCadenas.remove(elem);
                break; // Se encuentra y elimina la cadena, no es necesario continuar buscando
            }
        }
    }
    ...
    {
    	return arbolCadenas.containsAll(List.of(otroArreglo));
    }
